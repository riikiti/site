...
<main id="main">
    <div class="links">
        ...
        <a  href="/CRUD/uNews/adminN.php">Новости</a>
        <a href="/CRUD/uReviews/adminR.php">Отзывы</a>
        <a class="l-selected" href="/CRUD/uState/adminState.php">Статьи</a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">АДМИНКА - СТАТЬИ</h2>
                    ...
                    if ($result = mysqli_query($link, $sql)) {
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                echo "<a href='updateState.php?id=" . $row['id_state'] . "' title='Update Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                echo "<a href='deleteState.php?id=" . $row['id_state'] . "' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                echo "</td>";
                                echo "</tr>";
                            }
                            echo "</tbody>";
