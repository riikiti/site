...
<main id="main">
    <div class="links">
        ...
        <a class="l-selected" href="/CRUD/uReviews/adminR.php">Отзывы</a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">АДМИНКА - Отзывы</h2>
                    </div>
                    <?php
                    // Include config file
                    ...
                    if ($result = mysqli_query($link, $sql)) {
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                echo "<tr>";
                                echo "<td>" . $row['id_reviews'] . "</td>";
                                echo "<td>" . $row['login'] . "</td>";
                                echo "<td>" . $row['text'] . "</td>";
                                echo "<td>" . $row['date'] . "</td>";
                                echo "<td>" . $row['id_state'] . "</td>";
                                echo "<td>";
                                echo "<a href='deleteR.php?id=" . $row['id_reviews'] . "' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                echo "</td>";
                                echo "</tr>";
                            }
                            echo "</tbody>";
