...
<main id="main">
    <div class="links">
        <a  href="/CRUD/uClient/adminC.php">Посетители</a>
        <a class="l-selected" href="/CRUD/uNews/adminN.php">Новости</a>
        <a href="/CRUD/uReviews/adminR.php">Отзывы</a>
        <a href="/CRUD/uState/adminState.php">Статьи</a>
        <a href="/CRUD/uSale/adminSale.php">Скидки</a>
        <a  href="/CRUD/uCS/adminCS.php">Покупки клиентов</a>
    </div>
    <div class="wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">АДМИНКА - Новости</h2>
                        <a href="createN.php" class="btn btn-success pull-right">Добавить новую Запись</a>
                    </div>
                    <?php
                    // Include config file
                    ...
                    if ($result = mysqli_query($link, $sql)) {
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                echo "<td>" . $row['time'] . "</td>";
                                echo "<td>";
                                echo "<a href='updateN.php?id=" . $row['id_news'] . "' title='Update Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                echo "<a href='deleteN.php?id=" . $row['id_news'] . "' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                echo "</td>";
                                echo "</tr>";
                            }
                            echo "</tbody>";
