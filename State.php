...
<main>
    <div class="wrap-cars">
        <div class="cars-content">
            <h1 class="cars-tittle">Магазин статей</h1>
...
// вообщем мы выводим из таблицы только скидки которые подходят по дате ну и статье
                                    ...
                                    echo " <p> $description</p>";
                                    echo " <p>$date</p>";
                                    echo " <p> $res_price руб.</p>";
                                    echo " <p> С учетом скидки*</p>";
                                    echo "<button class='third'>Купить</button>";
                                    echo " <input hidden name='id_state' value='$id_state'>";
                                    echo " <input hidden name='res_price' value='$res_price'>";
...
// ну а тут собственно для не авторизированных пользователей
                                ...
                                echo " <p>$date</p>";
                                echo " <p>$price руб.</p>";
                                echo "<button $disabled class='third'>Купить</button>";
                                echo " </div>";
                                echo "</form>";
